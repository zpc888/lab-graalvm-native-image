...
This [original repo](https://github.com/SoftInstigate/classgraph-on-graalvm/tree/master) demonstrates how to build a native image of a java application that uses [ClassGraph](https://github.com/classgraph/classgraph) with [GraalVM](https://github.com/oracle/graal).
